...
is then proposed to offer predictable network performance for each accepted tenant, and minimize  datacenter bandwidth utilization. Finally, we present a probability based approach to solve the middlebox scaling problem through reserving extra free virtual machine (VM) resources. Extensive simulation results based on current large-scale datacenter networks verify that EMAP can accept more tenant requests than existing placement algorithm (e.g., Stratos) while saving almost 10\% more core-level bandwidth and our middlebox scaling approach can accommodate the scaling requirments effectively.
...
\begin{figure}[H]
	...
	\subfigure[Accept rates under different $B^{in}$]{
		\includegraphics[width=3.5in,height=2.5in]{fig/accept_rate_bin.pdf}
	...
	\subfigure[Accept rates under different $B^{ex}$]{
		\centering
		\includegraphics[width=3.5in,height=2.5in]{fig/accept_rate_bex.pdf}
...
\begin{figure}[H]
	...
	\subfigure[VM slot utilizations under different $B^{in}$]{
		...
		\includegraphics[width=3.5in, height=2.5in]{fig/vm_util_bin.pdf}
	}
	\subfigure[VM slot utilizations under different $B^{ex}$]{
		\label{fig:vm_util_bex}
		\includegraphics[width=3.5in, height=2.5in]{fig/vm_util_bex.pdf}
	}
	%\label{fig:vm_util}
...
\begin{figure}[H]
	...
	\subfigure[Core-aggregation links' bandwidth utilizations]{
		\label{fig:agg_core}
		\includegraphics[width=3.5in,height=2.5in]{fig/high_bw_util.pdf}}
	\subfigure[ToR-PM links' bandwidth utilizations]{
		\label{fig:pm_agg}
		\includegraphics[width=3.5in,height=2.5in]{fig/low_bw_util.pdf}}
