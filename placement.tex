...
\begin{figure}
	...
	\subfigure[Accept rates under different $B^{in}$]{
		\includegraphics[width=3.5in,height=2.0in]{fig/accept_rate_bin.pdf}
	...
	\subfigure[Accept rates under different $B^{ex}$]{
		\centering
		\includegraphics[width=3.5in,height=2.0in]{fig/accept_rate_bex.pdf}
...
\begin{figure}
	...
	\subfigure[VM slot utilizations under different $B^{in}$]{
		...
		\includegraphics[width=3.5in, height=2.0in]{fig/vm_util_bin.pdf}
	}
	\subfigure[VM slot utilizations under different $B^{ex}$]{
		\label{fig:vm_util_bex}
		\includegraphics[width=3.5in, height=2.0in]{fig/vm_util_bex.pdf}
	}
	%\label{fig:vm_util}
...
\begin{figure}
	...
	\subfigure[Core-aggregation links' bandwidth utilizations]{
		\label{fig:agg_core}
		\includegraphics[width=3.3in]{fig/high_bw_util.pdf}}
	\subfigure[ToR-PM links' bandwidth utilizations]{
		\label{fig:pm_agg}
		\includegraphics[width=3.3in]{fig/low_bw_util.pdf}}
